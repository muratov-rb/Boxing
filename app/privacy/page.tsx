...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      "Photos you choose to submit: a food photo for the calorie scanner. We do not access your camera without asking, and the scanner shows a consent prompt before the camera is opened.",
  ...
  },
  {
    ...
    blocks: [
      ...
      [
        ...
        "Anthropic — provides the AI behind the goal analysis, nutrition plans and food photo scanning. When you use one of those features, the relevant information is sent to Anthropic to generate the response. For the scanner, that includes the photo you submitted.",
      ],
  ...
  },
  {
    ...
    blocks: [
      ...
      "Photos you submit for scanning are processed to generate your result and are not kept in your account afterwards. Our AI provider may retain them briefly for abuse monitoring under their own policy.",
